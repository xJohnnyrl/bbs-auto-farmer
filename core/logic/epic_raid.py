    ...
    while should_continue(tickets_used):
        ...
        if check_image_present("assets/icons/create_room_epic_raid.png", screenshot=screenshot):
            ...
            if (find_and_click_image("assets/icons/confirm.png", screenshot=screenshot)):
                ...
                while in_menu:
                    screenshot = get_bbs_screenshot()
                    if (not check_image_present("assets/icons/epic_raid_locked.png", screenshot=screenshot) and not(check_image_present("assets/icons/empty_epic_raid.png", screenshot=screenshot))):
