...
def handle_end_menu_singleplayer():
    last_icon = None
    times_tried = 0
    ...
    while not stop_controller.should_stop():
        ...
        icon_clicked = False
        returns = ["human_world", "soul_society", "hueco_mundo", "side_stories", "others"]
        for icon in ["tap_screen", "cancel", "close", "tap_here_to_continue", "human_world", "soul_society", "hueco_mundo", "side_stories", "others"]:
